...
const Pages: Page[] = [
  ...
  },
  {
    ...
    lead: "Accurate attribution is essential in the iGEM Competition. It ensures that the judges can properly assess your team's contributions and recognize the support provided by external collaborators.",
  },
  {
  ...
  },
  {
    ...
    lead: "Synthetic Biology needs great measurement approaches for characterizing parts, and efficient new methods for characterizing many parts at once.",
  },
  {
    name: "Plant",
    title: "Plant",
  ...
  },
  {
    ...
    lead: "Detail the safety and security considerations of your project, addressing potential risks and outlining the measures taken to mitigate them.",
  },
  {
    name: "Software",
    title: "Software",
  ...
  },
  {
    ...
    lead: "We ask every team to think deeply and creatively about whether their project is responsible and good for the world.",
  },
  {
    name: "Education",
    title: "Education",
    path: "/education",
    component: Education,
    lead: "Innovative educational tools and outreach activities have the ability to establish a two-way dialogue with new communities.",
  },
  {
    name: "Inclusivity",
